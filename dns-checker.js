 ...
 * @param  {[type]}   selfDomain [description]
 ...
 */
exports.isSamePointed = function(domain, done){
	...
	dns.resolve(domain, function (err, addresses) {
		...
		if(matched){
			...
			var err = new Error('DNS record for '+domain +' points to another ip adress');
			err.code = 'anotherip'
			console.log(err);
